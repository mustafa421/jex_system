...
{	
	...
	function db_functions($cfg_server,$cfg_commondbuser,$cfg_commondbpwd,$cfg_commondbname,$tableprefix,$theme,$language)
	{
		...
		$this->lang=$language;
		$this->conn = mysql_connect("$server", "$cfg_commondbuser", "$cfg_commondbpwd") or die("Could not connect : " . mysql_error());

		mysql_select_db("$cfg_commondbname",$this->conn) or die("Could not select database <b>$database</b>");
