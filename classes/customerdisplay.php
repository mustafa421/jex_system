       ...
       $backpage = $page - 1;
        ...
        if ($wheredata=='outofstock'){
		   if ($page=="1") { 
				...
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&outofstock=go&page=".$nextpage."'><font color=$urllinkcolor>".NextPage."</font></a> ";
		
			}else if ($page == $total_pages) {
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&outofstock=go&page=".$backpage."'><font color=$urllinkcolor>".BackPage."</font></a>";
				echo " <a><font color=$pagenumcolor>|Page:$page of $total_pages|</font></a>";
		 	...
		 	if ($page=="1") { 
				...
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&reorder=go&page=".$nextpage."'><font color=$urllinkcolor>".NextPage."</font></a> ";
			}else if ($page == $total_pages) {
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&reorder=go&page=".$backpage."'><font color=$urllinkcolor>".BackPage."</font></a>";
				echo " <a><font color=$pagenumcolor>|Page:$page of $total_pages|</font></a>";
		 	...
		 	if ($page=="1") { 
				...
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&zeroprice=go&page=".$nextpage."'><font color=$urllinkcolor>".NextPage."</font></a> ";
			}else if ($page == $total_pages) {
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&zeroprice=go&page=".$backpage."'><font color=$urllinkcolor>".BackPage."</font></a>";
				echo " <a><font color=$pagenumcolor>|Page:$page of $total_pages|</font></a>";
		 	...
		 	if ($page=="1") { 
				...
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&usingsearch=go&searching_by=$wherefield&search=$wheredata&page=".$nextpage."'><font color=$urllinkcolor>".NextPage."</font></a> ";
			}else if ($page == $total_pages) {
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&usingsearch=go&searching_by=$wherefield&search=$wheredata&page=".$backpage."'><font color=$urllinkcolor>".BackPage."</font></a>";
				echo " <a><font color=$pagenumcolor>|Page:$page of $total_pages|</font></a>";
		 	...
		 	if ($page=="1") { 
				...
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&page=".$nextpage."'><font color=$urllinkcolor>".NextPage."</font></a> ";
			}else if ($page == $total_pages) {
				echo "<a href='manage_customers.php?nextrec=yes&totalpages=$total_pages&page=".$backpage."'><font color=$urllinkcolor>".BackPage."</font></a>";
				echo " <a><font color=$pagenumcolor>|Page:$page of $total_pages|</font></a>";
