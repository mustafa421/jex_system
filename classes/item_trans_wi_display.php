	...
	if ($usertype=="Admin"){
		...
		if ($cfg_enable_PopUpUpdateform=="yes"){
			...
			echo "
				...
				<td align='center'>\n<a href=\"create_saleagreement_WI.php?working_on_id=$row[supplier_id]&active_trans_id=$row[transaction_id]&saonly=yes\"><font color='$this->rowcolor_link'>{$this->lang->createSaleagreement}</font></a></td>
				<td align='center'>\n<a href=\"create_saleagreement_WI.php?working_on_id=$row[supplier_id]&active_trans_id=$row[transaction_id]&checkonly=yes\"><font color='$this->rowcolor_link'>{$this->lang->CreateCheck}</font></a></td>
