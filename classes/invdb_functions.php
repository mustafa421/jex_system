...
{	
	...
	function db_functions($cfg_server,$cfg_shareINVdbuser,$cfg_shareINVdbpwd,$cfg_shareINVdbname,$tableprefix,$theme,$language)
	{
		...
		$this->lang=$language;
		$this->conn = mysql_connect("$server", "$cfg_shareINVdbuser", "$cfg_shareINVdbpwd") or die("Could not connect : " . mysql_error());

		mysql_select_db("$cfg_shareINVdbname",$this->conn) or die("Could not select database <b>$database</b>");
