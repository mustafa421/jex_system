...
/*Start of OnFocus Clear default value
...
echo " | ";
echo "<a href=\"form_items_videogame_dvd.php?action=insert&working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]\">Add video game DVD</a>";
...
$f1=new form('return validateFormOnSubmit(this)','process_form_items_dvd.php','POST','dvds','400',$cfg_theme,$lang);
