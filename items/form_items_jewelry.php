...
var valaddtoinventory=form.addtoinventory.value; 
...
self.location='form_items_jewelry.php?reloadcat=yes&valitem_number_value=' + valitemnumber
...
+'&valaddtoinventory=' + valaddtoinventory
+'&valaction=' + valaction
+'&valid=' + valid
...
var reason = "";
 ...
 reason += validateWatch(theForm.category_id,theForm.serialnumber);
...
function validatedescription(fld) {
    var error = "";
    alert("Make sure to enter jewelry transaction number in description!");
...
if ($_GET['addjewelrytoinventory'] == 'yes'){$addtoinventory_checked = 'Y';}
...
if($action=="update")
{
	...
	if(isset($_GET['id']))
	{
		...
		if ($row['addtoinventory'] == 'Y'){$addtoinventory_checked = 'Y';}
...
else
{
	  ...
	  $display->displayTitle("Add Scrap Gold to Inventory for Resale");
	  $addtrnsmsg="<br> Please Enter Jewelry buy Transaction Number in Jewelry Description. \n";
      echo "<center><b><font color='blue'>$addtrnsmsg</font></b></center><br>";
...
$addtoinventory_checked=$_GET['valaddtoinventory'];
...
$f1->createSelectField("<b>Material-Type:</b>",'material_type',$materialtype_option_values,$materialtype_option_titles,'160');
...
$addscrapgoldforresale_checked = 'Y';
echo "
		...
		<input type='hidden' name='addscrapgoldforresale' value='$addscrapgoldforresale_checked'>
		<input type='hidden' name='action' value='$action'>
		<input type='hidden' name='id' value='$id'>";
$f1->endForm();

echo "<center><b><font color='blue'>$addtrnsmsg</font></b></center>";
$dbf->closeDBlink();
...
<br> <br> 
<b><font color='blue'>Important Note<br> 
</font></b><b><font color='green'>You must use Supplier "Jewelry and Electronic" to added Scrap Gold for ReSale.<br> 
</font></b><b><font color='green'>This screen is ONLY used to add Jewelry already Bought<br>
</font></b><b><font color='green'>as scrap therefore was not added to inventory. <br> 
</font></b><b><font color='green'>Jewelry added on this panel will get added to inventory<br> 
</font></b><b><font color='green'>for Resale and will not get counted as cost again.</font></b>
