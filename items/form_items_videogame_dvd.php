...
echo " | ";
echo "<a href=\"form_items_dvd.php?action=insert&working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]\">Add DVD</a>";
}else{
echo "<a href=\"form_buy_jewelry.php?action=insert&working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]\">Buy Jewelry</a>";
echo " | ";
echo "<a href=\"form_items.php?action=insert&working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]\">Add Items</a>";
...
if ($cfg_processForm_version=="1"){ 
	$f1=new form('return validateFormOnSubmit(this)','process_form_items_videogame_dvd_v1.php','POST','gamedvds','400',$cfg_theme,$lang);
}else if ($cfg_processForm_version=="2"){
	$f1=new form('return validateFormOnSubmit(this)','process_form_items_videogame_dvd_v2.php','POST','gamedvds','400',$cfg_theme,$lang);
}
