...
$id=-1;
	...
	elseif(isset($_POST['checknumber']) and isset($_POST['id']) and isset($_POST['action']) )
	
	{
		...
		{
			$field_names=array('checknumber','supplierid','transactionid','checkamount','bankname','date','id');
			$field_data=array("$checknumber","$supplierid","$transactionid","$checkamount","$bankname","$date","$id");	
