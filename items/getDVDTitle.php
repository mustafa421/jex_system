...
if(isset($_GET['getClientId'])){  
  ...
  if($inf = mysql_fetch_array($res2)){  
    ...
    $dvdtitle = str_replace("'", "", "$title_value"); 
   ...
   echo "formObj.description.value = \"$dvdtitle\";\n";
   ...
   echo "formObj.dvdtitle_in_catalog.value = 'yes';\n" ;
     ...
     echo "formObj.unit_price.value = \"$item_table_unitprice\";\n";
     echo "formObj.quantity.value = \"$quantity\";\n";
     echo "formObj.dvdtitle_in_catalog.value = 'no';\n" ; 
