...
echo " | ";
echo "<a href=\"form_items_videogame_dvd_v2.php?action=insert&working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]\">Add video game DVD</a>";
...
$f1=new form('return validateFormOnSubmit(this)',"form_items_dvd_v2.php?working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]",'POST','dvds_no','400',$cfg_theme,$lang);
}else{
$f1=new form('return validateFormOnSubmit(this)','process_form_items_dvd.php','POST','dvds_no','400',$cfg_theme,$lang);
}
