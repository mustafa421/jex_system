...
if (valaction == "insert") {
		...
		var enableimageupload_items = "<?php echo($cfg_enableimageupload_gdvd);?>";
...
var valgamedvdtitleincatalog=form.gamedvdtitle_in_catalog.value; 
...
self.location='form_items_videogame_dvd_v3.php?reloadcat=yes&valitem_number_value=' + valitemnumber
...
+'&valgamedvdtitleincatalog=' + valgamedvdtitleincatalog
...
echo " | ";
echo "<a href=\"form_items_dvd_v3.php?action=insert&working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]\">Buy/Add Movies</a>";
}else{
echo "<a href=\"form_buy_jewelry.php?action=insert&working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]\">Buy Jewelry</a>";
echo " | ";
echo "<a href=\"form_items.php?action=insert&working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]\">Buy/Add Items</a>";
...
$f1=new form('return validateFormOnSubmit(this)',"form_items_videogame_dvd_v3.php?working_on_id=$_GET[working_on_id]&active_trans_id=$_GET[active_trans_id]",'POST','gamedvds_no','400',$cfg_theme,$lang);
}else{
	if ($cfg_processForm_version=="1"){ 
		$f1=new form('return validateFormOnSubmit(this)','process_form_items_videogame_dvd_v1.php','POST','gamedvds_no','400',$cfg_theme,$lang);
	}else if ($cfg_processForm_version=="2"){
		$f1=new form('return validateFormOnSubmit(this)','process_form_items_videogame_dvd_v2.php','POST','gamedvds_no','400',$cfg_theme,$lang);
	}
}	
...
$wherefield = ' a.category_id = ' ." '". "$catid"."'".'and  a.category_id = b.id and b.showon_gamespanel = '."'".'Y'. "'" .' and a.activate_article = '."'".'Y'. "'";
...
$f1->createInputField("Item_Found:",'checkbox','itemfound',"N",'10','160',"$itemfound_checked");
