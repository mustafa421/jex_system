...
$field_names=array('sale_id','item_id','upc','quantity_purchased','item_unit_price','item_buy_price','item_tax_percent','item_total_tax','item_total_cost');
...
for($k=0;$k<$num_items;$k++)
{
	...
	$field_data=array("$saleID","$temp_item_id","$temp_item_number","$temp_quantity_purchased","$temp_item_unit_price","$temp_item_buy_price","$temp_item_tax_percent","$temp_item_tax","$temp_item_cost");
