...
<li><a class="active" href="#" onClick="window.open('../items/suppliers/manage_suppliers.php','MainFrame','toolbar=0,scrollbars=1,width=880,height=300,resizable=0');return false;"><span>Buy Item</span></a></li>

<li><a class="active" href="#" onClick="window.open('../sales/sale_ui.php','MainFrame','toolbar=0,scrollbars=1,width=880,height=300,resizable=0');return false;"><span>Sell Item</span></a></li>
