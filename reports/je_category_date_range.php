...
$tableheaders=array("$lang->date","Total Category bought cost");
$display->displayTotalsReport($cfg_tableprefix,'categorycostreport',$tableheaders,$date1,$date2,'id',"$selected_item");
?>
