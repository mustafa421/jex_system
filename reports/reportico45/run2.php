 ...
 */
   ...
   // $q->initial_report = "projects/Reports/Refund_Report.xml";
   ...
   // $q->compiled_templates_folder = "reportico45/templates_c";
   ...
   // $q->show_refresh_button = false;
    ...
    define('SW_FRAMEWORK_DB_PASSWORD','');
    define('SW_FRAMEWORK_DB_HOST', '127.0.0.1'); // Use ip:port to specifiy a non standard port
    define('SW_FRAMEWORK_DB_DATABASE', '');
