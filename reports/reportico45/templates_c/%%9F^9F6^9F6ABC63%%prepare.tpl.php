<?php /* Smarty version 2.6.26, created on 2016-11-22 21:27:35
...
<?php if ($this->_tpl_vars['BOOTSTRAP_STYLES'] && $this->_tpl_vars['BOOTSTRAP_STYLES'] == '3'): ?>
...
>
                    ...
                    <label style="min-width: 120px" class="form-control" aria-label="Text input with checkbox"><?php echo $this->_tpl_vars['T_SHOW_GRAPH']; ?>
</label>
<?php if ($this->_tpl_vars['OUTPUT_SHOW_SHOWGRAPH']): ?>
                    <span class="input-group-addon">
                        <input type="checkbox" name="target_show_graph" value="1" <?php echo $this->_tpl_vars['OUTPUT_SHOWCRITERIA']; ?>
>
                    </span>
                    <label style="min-width: 120px"  class="form-control" aria-label="Text input with checkbox"><?php echo $this->_tpl_vars['T_SHOW_CRITERIA']; ?>
</label>
<?php else: ?>
                        <input style="display: none" type="checkbox" name="target_show_graph" value="1" <?php echo $this->_tpl_vars['OUTPUT_SHOWCRITERIA']; ?>
>
<?php endif; ?>
                </div><!-- /input-group -->
<?php else: ?>
			<div style="width: auto; padding: 5px; float: right;vertical-align: bottom;text-align: right">
				<span style="margin-right: 20px"> <INPUT type="checkbox" name="target_show_criteria" value="1" <?php echo $this->_tpl_vars['OUTPUT_SHOWCRITERIA']; ?>
><?php echo $this->_tpl_vars['T_SHOW_CRITERIA']; ?>
</span>
<?php if ($this->_tpl_vars['OUTPUT_SHOW_SHOWGRAPH']): ?>
				<span style="margin-right: 20px"> <INPUT type="checkbox" name="target_show_graph" value="1" <?php echo $this->_tpl_vars['OUTPUT_SHOWCRITERIA']; ?>
...
>
                    ...
                    <label style="max-width: 160px"  class="form-control" aria-label="Text input with checkbox"><?php echo $this->_tpl_vars['T_SHOW_GRAPH']; ?>
</label>
<?php else: ?>
                        <input style="display: none" type="checkbox" name="target_show_graph" value="1" <?php echo $this->_tpl_vars['OUTPUT_SHOWCRITERIA']; ?>
>
...
>
                    ...
                    <label style="max-width: 160px"  class="form-control" aria-label="Text input with checkbox"><?php echo $this->_tpl_vars['T_SHOW_CRITERIA']; ?>
</label>
                </div><!-- /input-group -->
			</div>
<?php else: ?>
				<span style="margin-right: 20px; float: right"> <INPUT type="checkbox" name="target_show_criteria" value="1" <?php echo $this->_tpl_vars['OUTPUT_SHOWCRITERIA']; ?>
><?php echo $this->_tpl_vars['T_SHOW_CRITERIA']; ?>
</span>
<?php if ($this->_tpl_vars['OUTPUT_SHOW_SHOWGRAPH']): ?>
